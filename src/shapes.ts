...
export class Cube{
    ...
    private readonly vert_indices : Uint16Array
    ...
    constructor({gl, renderer, position=vec3.fromValues(0,0,0), rotation=quat.create()}: {
        ...
        this.vao = new StandardVAO({
            gl: gl,
            program: renderer,
            a_position_data: this.verts,
            a_position_indices: this.vert_indices
        })
    }
    ...
    public render(camera: Camera){
        ...
        this.renderer.run({vao: this.vao, u_object_to_clip_value: object_to_clip_matrix});
    }
}